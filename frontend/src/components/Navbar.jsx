	...
	return (
		<nav className="fixed z-20 w-full bg-blue-950">
			<div className="max-w-screen-xl flex items-center justify-between mx-auto p-4">
				...
				<div className="items-center hidden w-auto md:flex md:order-2">
				...
				<button className="bg-red-400 rounded-full p-3 border-2 border-red-50 hidden md:block md:order-2 cursor-pointer hover:bg-red-600">
					<svg
						fill="#ffffff"
						version="1.1"
						id="Layer_1"
